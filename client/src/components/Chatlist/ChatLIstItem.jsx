  ...
  return (
    ...
    >
      ...
      <div className="min-h-full flex flex-col justify-center mt-3 pr-2 w-full">
        ...
        <div className="flex border-b border-conversation-border pt-1 pb-2 pr-2">
          <div className="flex justify-between w-full">
            <span className="text-secondary line-clamp-1 text-sm">
              {isContactsPage ? (
                data?.about || "\u00A0"
              ) : (
                <div className="flex items-center max-w-[200px] gap-1 sm:max-w-[250px] md:max-w-[300px] lg:max-w-[200px] xl:max-w-[300px]">
